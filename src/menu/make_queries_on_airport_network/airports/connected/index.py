...
def display_is_airport_connected_menu():
    ...
    is_connected = graph.is_connected(source_airport_id, destination_airport_id)

    print(f"{source_airport_id} {"is" if is_connected else "isn't" } connected with {destination_airport_id}")